...
The order lifecycle. Consumes payment and delivery events instead of calling those services.
...
from app.router import cart_router, router
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        _relay.start()
    except Exception:  # noqa: BLE001 — a broker outage must not stop checkout
