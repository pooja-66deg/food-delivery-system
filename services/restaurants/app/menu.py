...
async def add_category(
    session: AsyncSession, user: Identity, restaurant_id: int, data: CategoryCreate
) -> MenuCategory:
...
async def update_category(
    session: AsyncSession, user: Identity, restaurant_id: int, category_id: int, data: CategoryUpdate
) -> MenuCategory:
...
async def delete_category(
    session: AsyncSession, user: Identity, restaurant_id: int, category_id: int
) -> None:
...
async def add_item(
    session: AsyncSession, user: Identity, restaurant_id: int, data: MenuItemCreate
) -> MenuItem:
    await service.owned_restaurant(session, user, restaurant_id)
...
async def update_item(
    session: AsyncSession, user: Identity, restaurant_id: int, item_id: int, data: MenuItemUpdate
) -> MenuItem:
    await service.owned_restaurant(session, user, restaurant_id)
...
async def delete_item(session: AsyncSession, user: Identity, restaurant_id: int, item_id: int) -> None:
    await service.owned_restaurant(session, user, restaurant_id)
    item = await _item_in_restaurant(session, restaurant_id, item_id)
